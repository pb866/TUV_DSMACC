...
* 5 = JPL 2006, bin-to-bin interpolation
      ...
      spc = "NO2"
      xsvers = (/4, 6, 4/) ! options for vers = 1/2/0 (TUV/MCM&GECKO-A/individual)
      logmsg(1) = "for transmission from Davidson et al. (1988)"
      logmsg(2) = "for transmission from JPL 1994 - 2002 evaluations"
      logmsg(3) = "for transmission from Harder et al"
      WRITE(logmsg(4),"(2A)") "for transmission from JPL 2006",
     &                " interpolating between midpoints of bins"
      logmsg(5) =
     &      "for transmission from JPL 2006, bin-to-bin interpolation"
      logmsg(6) = "for transmission' from IUPAC recommendation"
...
* interpolate to wavelength grid
      ...
      CALL interpol(x1,y1,kdata,n,nw,wl,fil,0.,0.,yg)
